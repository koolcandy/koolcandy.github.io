...
先计算内循环：
$$
\begin{aligned}&C_T=C_0+N(C_{_{BK}}){-12}\\&C_T=4+3000(20)-12\\&C_T=599992\end{aligned}
$$
然后计算外循环
$$
\begin{aligned}&C_T=C_0+N(C_{_BK})-12\\&C_T=4+30000(59992+2+16)-12\\&C_T=1.8\times10^{10}\text{Clock cycles}\end{aligned}
$$
